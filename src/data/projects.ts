...
const project = <T extends Omit<Project, 'image'> & { slug: keyof typeof projectImages }>(
  item: T
): Project => ({
  ...item,
...
export const projects: readonly Project[] = [
  project({
    ...
    links: [
      { label: 'View Career Ready', href: 'https://www.pearson.com/en-us/career-ready.html' },
    ],
    featured: true,
  }),
  project({
  ...
  project({
    ...
    period: '2026',
    summary:
      'A monthly fitness-competition scoring system that publishes participant results to a static site.',
    contribution:
      'Built a tested Python scoring core, a local FastAPI administration flow, and a React/Vite static participant site.',
    technologies: ['Python', 'FastAPI', 'React', 'Vite', 'TypeScript', 'GitHub Pages'],
    links: [{ label: 'View source on GitHub', href: 'https://github.com/diogobas/gymrats' }],
    featured: true,
  }),
  project({
    slug: 'etikagis',
    ...
    contribution:
      'Maintained as a public archival repository; the available source identifies Visual Basic and classic ASP technologies.',
    technologies: ['Visual Basic', 'ASP', 'JavaScript', 'CSS'],
    links: [{ label: 'View source on GitHub', href: 'https://github.com/diogobas/etikagis' }],
    featured: false,
  }),
  project({
    slug: 'taskflow-fullstack',
    title: 'TaskFlow Fullstack',
    type: 'personal',
    company: 'Personal project',
    period: '2026',
    summary:
      'A full-stack task-management learning project exploring a React client, serverless Node.js services, and AWS infrastructure.',
    contribution:
      'Built as a learning project with a documented architecture spanning React, TypeScript, Node.js, AWS, DynamoDB, and PostgreSQL.',
    technologies: ['React', 'TypeScript', 'Node.js', 'AWS', 'DynamoDB', 'PostgreSQL'],
    links: [
      { label: 'View source on GitHub', href: 'https://github.com/diogobas/taskflow-fullstack' },
    ],
    featured: false,
  }),
  project({
    slug: 'json-transformer-api',
    ...
    contribution:
      'Built an Express and TypeScript API with rate limiting and unit and integration tests.',
    technologies: ['Node.js', 'TypeScript', 'Express', 'Jest', 'Supertest'],
    links: [
      { label: 'View source on GitHub', href: 'https://github.com/diogobas/json-transformer-api' },
    ],
    featured: false,
  }),
  project({
    ...
    period: '2026',
    summary:
      'A multiplayer card-game application with a REST backend and an interactive web client.',
    contribution:
      'Built the project around a Java/Spring Boot backend and a React/TypeScript frontend using Material UI.',
    technologies: ['Java', 'Spring Boot', 'React', 'TypeScript', 'Material UI'],
    links: [{ label: 'View source on GitHub', href: 'https://github.com/diogobas/deckgame' }],
    featured: false,
  }),
];
